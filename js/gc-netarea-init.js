...
function gcGetBaseURL() {
    ...
    let scriptURL = document.getElementById("gc-netarea-init");
...
function initComponent() {
    ...
    */
    ...
    // change for DEBUG to js/gc-netarea.js
    loadJSscript("js/gc-netarea.js", function() {
        ...
        vmRoot = new Vue({
            ...
            i18n: i18n,
            created() {
              console.debug("gc-netarea-init created!");
...
function loadJSscript (url, callback) {
    /* 
      ...
      */
    console.debug("gc-netarea-init - loadJSscript()");
    let script = document.createElement("script");  // create a script DOM node
    script.type = 'text/javascript';
